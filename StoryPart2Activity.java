...
public class StoryPart2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.story_part2);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.part2);
        ...
        databaseReference.child("part2").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(StoryPart2Activity.this, "Failed to load data!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        speaker.setOnClickListener(v -> {
            String text = "නරි රාලට හමුවුනේ කුමක්ද ? බිත්තරයක්,  ගලක්,  කොහොල්ලෑ ගුලියක්,  යාළුවෙක්";
    ...
    public void openstory3Activity() {
        Intent intent = new Intent(this, StoryPart3Activity.class);
