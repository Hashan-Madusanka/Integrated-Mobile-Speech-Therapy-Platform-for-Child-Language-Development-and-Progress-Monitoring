...
public class EnglishSpeech4 extends AppCompatActivity {
    ...
    private String targetWord = "Train";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.english_speech4);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.train);
    ...
    private void startSpeechToText(){
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "Train");
    ...
    public void openspeechActivity(){
        Intent intent = new Intent(this, EnglishSpeech5.class);
        startActivity(intent);
    }
