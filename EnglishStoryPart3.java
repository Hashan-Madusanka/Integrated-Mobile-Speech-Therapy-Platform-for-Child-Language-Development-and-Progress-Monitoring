...
public class EnglishStoryPart3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.english_story_part3);
        ...
        next.setOnClickListener(v -> openstory3Activity());
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.engstory3);
        ...
        databaseReference.child("part3").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Boolean isCorrect = snapshot.getValue(Boolean.class);
                if (isCorrect != null && isCorrect) {
                    correctImage.setVisibility(View.VISIBLE); // Show correct icon if part3 is true
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(EnglishStoryPart3.this, "Failed to load data!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        speaker.setOnClickListener(v -> {
            String text = "What did the dog do to the other dog? He Smiled at him,  He Barked At him,  He Growled at him, He Shout at Him";
    ...
    public void openstory3Activity() {
        Intent intent = new Intent(this, EnglishStoryPart4.class);
        startActivity(intent);
    }
}