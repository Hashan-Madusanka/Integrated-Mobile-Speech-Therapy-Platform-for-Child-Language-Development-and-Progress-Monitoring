...
public class Speech4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //video
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.speech4);
        // Set the video URI
    ...
    private void startSpeechToText() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "මාමා");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == SPEECH_REQUEST_CODE && resultCode == RESULT_OK && data != null) {
            ...
            if (results != null && results.size() > 0) {
                ...
                // Retrieve existing spell_4 node value
                userRef.child("spell_4").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        long spell_4Value = snapshot.getValue(Long.class) != null ? snapshot.getValue(Long.class) : 0;
                        ...
                        if (spokenText.equals(targetWord)) {
                            ...
                            userRef.child("spell_4").setValue(1);
    ...
    public void openspeechActivity() {
        Intent intent = new Intent(this, Speech2Activity.class);
    ...
    private void startRecording() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Speech4Activity.this);
        LayoutInflater inflater = getLayoutInflater();
        View dialogView = inflater.inflate(R.layout.dialog_recording, null);
        builder.setView(dialogView);
        // Set up recording
        outputFilePath = getExternalCacheDir().getAbsolutePath() + "/speech_audio4.3gp"; // Save to cache directory
