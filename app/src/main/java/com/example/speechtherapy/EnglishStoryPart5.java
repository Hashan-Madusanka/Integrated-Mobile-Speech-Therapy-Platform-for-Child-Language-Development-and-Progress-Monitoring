...
public class EnglishStoryPart5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.english_story_part5);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.engstory5);
        ...
        databaseReference.child("part5").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Boolean isCorrect = snapshot.getValue(Boolean.class);
                if (isCorrect != null && isCorrect) {
                    correctImage.setVisibility(View.VISIBLE); // Show correct icon if part5 is true
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(EnglishStoryPart5.this, "Failed to load data!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        speaker.setOnClickListener(v -> {
            String text = "What is the Moral of the Story? Help Others in Need,  Dog is stupid,  Dog is greedy,  Be Happy with what you have";
