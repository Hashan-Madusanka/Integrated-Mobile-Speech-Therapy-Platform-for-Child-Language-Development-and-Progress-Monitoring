...
public class Speech6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.speech6);
        ...
        //video
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.speech6);
        // Set the video URI
    ...
    private void startSpeechToText() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "සමනලයා");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == SPEECH_REQUEST_CODE && resultCode == RESULT_OK && data != null) {
            ...
            if (results != null && results.size() > 0) {
                ...
                // Retrieve existing spell_6 node value
                userRef.child("spell_6").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        long spell_6Value = snapshot.getValue(Long.class) != null ? snapshot.getValue(Long.class) : 0;
    ...
    public void openspeechActivity() {
        Intent intent = new Intent(this, Speech3Activity.class);
    ...
    private void startRecording() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Speech6Activity.this);
        LayoutInflater inflater = getLayoutInflater();
        View dialogView = inflater.inflate(R.layout.dialog_recording, null);
        builder.setView(dialogView);
        // Set up recording
        outputFilePath = getExternalCacheDir().getAbsolutePath() + "/speech_audio6.3gp"; // Save to cache directory
