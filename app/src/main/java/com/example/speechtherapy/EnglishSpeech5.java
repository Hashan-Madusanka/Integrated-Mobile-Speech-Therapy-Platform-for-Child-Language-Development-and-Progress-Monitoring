...
public class EnglishSpeech5 extends AppCompatActivity {
    ...
    private String targetWord = "Elephant";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.english_speech5);
...
//        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.elephant);
//        videoView.setVideoURI(videoUri);
        ...
        //Check Firebase for spell status
        checkSpellStatus();
    }
    ...
    private void showRecordingDialog(){
        ...
        startButton.setOnClickListener(v->{
            startRecording();
            path.setText("Recording path: " + outputFilePath);
            startTimer();
        });
    ...
    private void startTimer() {
        countDownTimer = new CountDownTimer(Long.MAX_VALUE, 1000) {
            ...
            public void onFinish() {
                // Timer will not finish as we set it to Long.MAX_VALUE
            }
        };
    ...
    private void startSpeechToText(){
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "Elephant");
            ...
            if(results != null && results.size() > 0){
                ...
                userRef.child("spell_5").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        long spellValue = snapshot.getValue(Long.class) != null ? snapshot.getValue(Long.class) : 0;
    ...
    public void openspeechActivity(){
        Intent intent = new Intent(this, EnglishSpeech6.class);
        startActivity(intent);
    }
