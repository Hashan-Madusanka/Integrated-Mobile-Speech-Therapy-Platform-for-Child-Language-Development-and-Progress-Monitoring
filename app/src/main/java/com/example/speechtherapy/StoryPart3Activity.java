...
public class StoryPart3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.story_part3);
        ...
        next.setOnClickListener(v -> openstory4Activity());
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.part3);
        ...
        databaseReference.child("part3").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(StoryPart3Activity.this, "Failed to load data!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        speaker.setOnClickListener(v -> {
            String text = "නරිරාල හැදුවේ කුමක්ද ? පුංචි බබෙක්ගේ රුපයක්,  සුදු බෝනික්කෙක්,  හාවෙක්,  සුදු පබයෙක්";
    ...
    public void openstory4Activity() {
        Intent intent = new Intent(this, StoryPart4Activity.class);
