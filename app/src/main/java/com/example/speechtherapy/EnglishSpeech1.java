...
public class EnglishSpeech1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.english_speech1);
    ...
    private void startSpeechToText(){
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT,"Apple");
            ...
            if(results != null && results.size() > 0){
                ...
                userRef.child("spell_1").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        // Record pronunciation attempt in progress tracking with language parameter
                        ProgressDataManager.recordPronunciationAttempt(isCorrect, ProgressDataManager.LANGUAGE_ENGLISH);
    ...
    public void openspeechActivity(){
        Intent intent = new Intent(this, EnglishSpeech2.class);
