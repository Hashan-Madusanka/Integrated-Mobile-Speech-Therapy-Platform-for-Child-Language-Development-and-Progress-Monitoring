...
public class StoryPart5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.story_part5);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.part5);
        ...
        databaseReference.child("part5").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(StoryPart5Activity.this, "Failed to load data!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        speaker.setOnClickListener(v -> {
            String text = "මෙම කතාවෙන් ගතහැකි අදර්ෂය කුමක්ද ? නොදන්නා අය එක්ක කතාවට යන්න එපා,  නොදන්නා අය එක්ක කතාවට යන්න,  හාවා අහිංසකයි,  නරියා කපටි";
