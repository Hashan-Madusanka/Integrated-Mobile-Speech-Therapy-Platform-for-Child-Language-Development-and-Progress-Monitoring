...
public class Sound2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sound2);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.cat2);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.child("animal2").getValue(Boolean.class) != null) {
                    boolean isCorrect = snapshot.child("animal2").getValue(Boolean.class);
                    if (isCorrect) {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Sound2Activity.this, "Error loading data", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void handleCardClick(boolean isCorrect, ImageView correctImageView) {
        if (isCorrect) {
            ...
            databaseReference.child("animal2").setValue(true);
        } else {
            // Update Firebase to indicate incorrect answer
            databaseReference.child("animal2").setValue(false);
    ...
    public void opennextActivity() {
        Intent intent = new Intent(this,Sound3Activity.class);
        startActivity(intent);
    }
}
