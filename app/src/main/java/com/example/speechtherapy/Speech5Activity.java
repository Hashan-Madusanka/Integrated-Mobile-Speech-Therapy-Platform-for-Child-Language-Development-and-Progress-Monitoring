...
public class Speech5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.speech5);
        ...
        //video
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.speech5);
        // Set the video URI
    ...
    private void startSpeechToText() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "වතුර");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == SPEECH_REQUEST_CODE && resultCode == RESULT_OK && data != null) {
            ...
            if (results != null && results.size() > 0) {
                ...
                // Retrieve existing spell_5 node value
                userRef.child("spell_5").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        long spell_5Value = snapshot.getValue(Long.class) != null ? snapshot.getValue(Long.class) : 0;
                        ...
                        if (spokenText.equals(targetWord)) {
                            ...
                            userRef.child("spell_5").setValue(1);
    ...
    public void openspeechActivity() {
        Intent intent = new Intent(this, Speech6Activity.class);
    ...
    private void startRecording() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Speech5Activity.this);
        LayoutInflater inflater = getLayoutInflater();
        View dialogView = inflater.inflate(R.layout.dialog_recording, null);
        builder.setView(dialogView);
        // Set up recording
        outputFilePath = getExternalCacheDir().getAbsolutePath() + "/speech_audio5.3gp"; // Save to cache directory
