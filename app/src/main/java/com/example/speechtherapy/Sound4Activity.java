...
public class Sound4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sound4);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.rooster);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.child("animal4").getValue(Boolean.class) != null) {
                    boolean isCorrect = snapshot.child("animal4").getValue(Boolean.class);
                    if (isCorrect) {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Sound4Activity.this, "Error loading data", Toast.LENGTH_SHORT).show();
            }
        });

        // Handle card clicks
        card1.setOnClickListener(v -> handleCardClick(false, null));
        card2.setOnClickListener(v -> handleCardClick(true, correct2));
    ...
    private void handleCardClick(boolean isCorrect, ImageView correctImageView) {
        if (isCorrect) {
            ...
            databaseReference.child("animal4").setValue(true);
        } else {
            // Update Firebase to indicate incorrect answer
            databaseReference.child("animal4").setValue(false);
    ...
    public void opennextActivity() {
        Intent intent = new Intent(this,Sound5Activity.class);
        startActivity(intent);
    }
}
