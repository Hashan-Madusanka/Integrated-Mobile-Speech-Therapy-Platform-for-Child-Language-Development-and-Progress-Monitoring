...
public class Speech1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.speech1);
        ...
        //video
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.rata);
        // Set the video URI
    ...
    private void startSpeechToText() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "රට");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == SPEECH_REQUEST_CODE && resultCode == RESULT_OK && data != null) {
            ...
            if (results != null && results.size() > 0) {
                ...
                // Retrieve existing spell_1 node value
                userRef.child("spell_1").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        // Record pronunciation attempt in progress tracking with Sinhala language
                        ProgressDataManager.recordPronunciationAttempt(isCorrect, ProgressDataManager.LANGUAGE_SINHALA);
                        
                        if (isCorrect) {
                            correct.setVisibility(View.VISIBLE);
                            // Increment count node and set spell_1 to 1 if not already set
                            userRef.child("spell_1").setValue(1);
    ...
    public void openspeechActivity() {
        Intent intent = new Intent(this, Speech4Activity.class);
    ...
    private void startRecording() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Speech1Activity.this);
        LayoutInflater inflater = getLayoutInflater();
        View dialogView = inflater.inflate(R.layout.dialog_recording, null);
        builder.setView(dialogView);
        // Set up recording
        outputFilePath = getExternalCacheDir().getAbsolutePath() + "/speech_audio1.3gp"; // Save to cache directory
