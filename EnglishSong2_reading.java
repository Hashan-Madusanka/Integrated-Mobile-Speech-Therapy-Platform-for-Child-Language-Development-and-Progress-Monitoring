...
public class EnglishSong2_reading extends AppCompatActivity {
    ...
    private List<List<String>> acceptableVariations = Arrays.asList(
            Arrays.asList("Little Teapot", "little tea pot"),
            Arrays.asList("Short and Stout", "short and stout"),
            Arrays.asList("Here is my handle","here is my handle"),
            Arrays.asList("Here is my spout","here is my spout"),
            Arrays.asList("Hear me shout","hear me shout"),
            Arrays.asList("Tip me over","tip me over")
    );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.english_song2_reading);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("engSong2").child(currentUserId);
    ...
    private void loadCorrectnessState(){
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(EnglishSong2_reading.this, "Failed to load data.", Toast.LENGTH_SHORT).show();
...
//        Store in Firebase
        resultReference.setValue(correctCount).addOnCompleteListener(task ->{
            if(task.isSuccessful()){
                Toast.makeText(EnglishSong2_reading.this, "Results Saved Successfully",Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(EnglishSong2_reading.this, "Failed to save results",Toast.LENGTH_SHORT).show();
            }
        });
    }
