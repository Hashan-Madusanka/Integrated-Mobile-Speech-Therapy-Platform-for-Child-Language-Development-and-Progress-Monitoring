...
public class EnglishStoryPart4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.english_story_part4);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.engstory4);
        ...
        databaseReference.child("part4").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (isCorrect != null && isCorrect) {
                    correctImage.setVisibility(View.VISIBLE); // Show correct icon if part4 is true
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(EnglishStoryPart4.this, "Failed to load data!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        speaker.setOnClickListener(v -> {
            String text = "To Where did the dog leaped into? Water, Snow, Grass, Floor";
    ...
    public void openstory2Activity() {
        Intent intent = new Intent(this, EnglishStoryPart5.class);
        startActivity(intent);
    }
}