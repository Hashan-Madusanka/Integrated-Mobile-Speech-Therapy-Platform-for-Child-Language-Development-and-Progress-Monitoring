...
public class Sound5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sound5);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.pig2);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.child("animal5").getValue(Boolean.class) != null) {
                    boolean isCorrect = snapshot.child("animal5").getValue(Boolean.class);
                    if (isCorrect) {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Sound5Activity.this, "Error loading data", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void handleCardClick(boolean isCorrect, ImageView correctImageView) {
        if (isCorrect) {
            ...
            databaseReference.child("animal5").setValue(true);
        } else {
            // Update Firebase to indicate incorrect answer
            databaseReference.child("animal5").setValue(false);
