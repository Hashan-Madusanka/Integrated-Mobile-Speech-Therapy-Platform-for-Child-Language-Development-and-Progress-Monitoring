...
public class EnglishSpeech3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.english_speech3);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.ducks);
    ...
    private void startSpeechToText(){
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT,"Duck");
    ...
    public void openspeechActivity(){
        Intent intent = new Intent(this, EnglishSpeech4.class);
