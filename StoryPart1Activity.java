...
public class StoryPart1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.story_part1);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.part1);
        ...
        databaseReference.child("part1").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(StoryPart1Activity.this, "Failed to load data!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        speaker.setOnClickListener(v -> {
            String text = "මෙම කතාවේ නම කුමක්ද? නරි බෑනා,  කොහොල්ලෑ බබා,  නරිහාමි,  කැලෑ ගම";
    ...
    public void openstory2Activity() {
        Intent intent = new Intent(this, StoryPart2Activity.class);
