...
public class Speech2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //video
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.amma);
        // Set the video URI
    ...
    private void startSpeechToText() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "අම්මා");
        try {
    ...
    public void openspeech3Activity() {
        Intent intent = new Intent(this, Speech5Activity.class);
    ...
    private void startRecording() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Speech2Activity.this);
        LayoutInflater inflater = getLayoutInflater();
        View dialogView = inflater.inflate(R.layout.dialog_recording, null);
        builder.setView(dialogView);
        // Set up recording
        outputFilePath = getExternalCacheDir().getAbsolutePath() + "/speech_audio2.3gp"; // Save to cache directory
