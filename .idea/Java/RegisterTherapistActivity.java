...
public class RegisterTherapistActivity extends AppCompatActivity {
        ...
        if (currentUser != null) {
            ...
            userRoleRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        if ("kid".equals(role)) {
                            ...
                            Intent intent = new Intent(RegisterTherapistActivity.this, HomeActivity.class);
                            ...
                            Intent intent = new Intent(RegisterTherapistActivity.this, UserChatListActivity.class);
                            startActivity(intent);
                            finish(); // Optional: Finish the current activity so user can't go back to login
                        }
                    }
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    ...
                    Toast.makeText(RegisterTherapistActivity.this, "Failed to retrieve role.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email) || !android.util.Patterns.EMAIL_ADDRESS.matcher(email).matches()) {
                    Toast.makeText(RegisterTherapistActivity.this, "Enter a valid email address", Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
                    return;
                }
                // Validate password
                if (TextUtils.isEmpty(password) || password.length() < 6) {
                    Toast.makeText(RegisterTherapistActivity.this, "Password must be at least 6 characters", Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
                    return;
                }
                // Validate username
                if (TextUtils.isEmpty(username)) {
                    Toast.makeText(RegisterTherapistActivity.this, "Please enter a username", Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
                    return;
                }
                // Validate username
                if (TextUtils.isEmpty(contact)) {
                    Toast.makeText(RegisterTherapistActivity.this, "Please enter a contact number", Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
                    return;
                }
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(RegisterTherapistActivity.this, "Account created", Toast.LENGTH_SHORT).show();
                                    openHomeActivity();
                                } else {
                                    // If sign in fails, display a message to the user.
                                    Toast.makeText(RegisterTherapistActivity.this, "Authentication failed.", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
            }
    ...
    public void openHomeActivity() {
        Intent intent = new Intent(this, UserChatListActivity.class);
        startActivity(intent);
    }
    ...
    private void storeUserInfo(String userId, String email, String username, String contact) {
        ...
        userMap.put("userRole", "therapist");
        // Store the user information in the database under the user's UID
        userRef.child(userId).setValue(userMap);
        DatabaseReference kidRef = FirebaseDatabase.getInstance().getReference().child("therapist");
        ...
        kidMap.put("username", username);  // Save the username from the input
        ...
        kidRef.child(userId).setValue(kidMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(RegisterTherapistActivity.this, "Therapist information saved.", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(RegisterTherapistActivity.this, "Failed to save Therapist information.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
