...
public class Sound3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sound3);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.cow2);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.child("animal3").getValue(Boolean.class) != null) {
                    boolean isCorrect = snapshot.child("animal3").getValue(Boolean.class);
                    if (isCorrect) {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Sound3Activity.this, "Error loading data", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        card3.setOnClickListener(v -> handleCardClick(true, correct3));
    }
    ...
    private void handleCardClick(boolean isCorrect, ImageView correctImageView) {
        if (isCorrect) {
            ...
            databaseReference.child("animal3").setValue(true);
        } else {
            // Update Firebase to indicate incorrect answer
            databaseReference.child("animal3").setValue(false);
    ...
    public void opennextActivity() {
        Intent intent = new Intent(this,Sound4Activity.class);
        startActivity(intent);
    }
}
